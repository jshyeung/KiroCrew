...
def run_script_sandboxed(
    ...
    try:
        ...
        sandboxed_argv, sandbox_cleanup = wrap_argv(
            argv, mode=sandbox_mode, extra_hidden_dirs=hidden, extra_private_dirs=apps_windows
        )
...
def run_command_sandboxed(
    ...
    try:
        ...
        if credential_mask_applies("cc"):
            ...
            apps_windows = ()
        sandboxed_argv, sandbox_cleanup = wrap_argv(
            argv, mode="cc", extra_hidden_dirs=(apps_tree,), extra_private_dirs=apps_windows
        )
        sandboxed_argv = cgroup_scope_argv(sandboxed_argv)  # cgroup DoS ceiling
        clean_env = _clean_cron_env()
