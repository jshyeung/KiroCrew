...
#:
#: A DELIBERATE DUPLICATE of the sum in the image's ``container/common/config.py``, not an
#: import of it. That tree runs inside the Linux image on an installed layout where
