...
SPAWN_RUN_SCHEMA = ToolSchema(
    ...
    fields=[
        ...
        FieldSpec("keep", bool),
        # Retired solo-spawn gate fields. No longer advertised and ignored,
        # but still accepted so a skill or workflow written against the old
        # schema is not refused as "unknown field".
