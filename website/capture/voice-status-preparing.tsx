...
const scenes: Record<string, { recording: boolean; level: number; download: SttModelProgress }> = {
  ...
  <div className="min-h-screen bg-canvas p-8">
    <div className="mx-auto w-[760px] rounded-lg border border-border overflow-hidden bg-chrome">
      ...
      <div className="px-3 py-6 text-[13px] text-muted">
        {chosen.recording ? 'Hold to talk — release to send.' : 'Released. The utterance is held for the model.'}
      </div>
    </div>
  </div>,
)
